...
const NotPlatingBarMobileTabArea = styled(NavLink)({
  display: "flex",
      ...
      {user ? (
        <>
          ...
          <NotPlayBarMobileContainer>
            ...
            <NotPlatingBarMobileTabArea to="/search">
              <MobileTabIcon
            ...
            <NotPlatingBarMobileTabArea to="/playlist">
              <MobileTabIcon

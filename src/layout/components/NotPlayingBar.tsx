...
const NotPlayingBar = () => {
  ...
  const NotPlatingBarMobileTabArea = styled("div")({
    display: "flex",
  ...
  const MobileTabIcon = styled("svg")(({ theme }) => ({
    height: "24px",
    width: "24px",
    ...
    <>
      ...
      <NotPlayBarMobileContainer>
        ...
        <NotPlatingBarMobileTabArea>
          ...
          <Typography fontSize={"11px"}>Premium</Typography>
        </NotPlatingBarMobileTabArea>
      </NotPlayBarMobileContainer>
    </>
  );
